$(function() {
  ...
  $.ajax({
    ...
    success: function(data) {
      ...
      if (!listall) {
        $(
          "<p style='color:red;text-align:center;font-size:30px;padding:20px 0'>抱歉，这个分类的数据还没有添加，每个下拉导航的第一个分类才有数据</p>"
        ).appendTo($(".listGoods"));
      } else {
  ...
  $(".mainList").on("mouseover", ".listImg", function() {
    ...
    //移入时创建详情页
    $(
      '<div class = "titleDiv"><div class = "titleImg"><img src="' +
        $(this).attr("src") +
        '" alt=""></div><h4 class = "proname">' +
        $(this)
          .parent()
          .nextAll("p")
          .children("a")
          .html() +
        '</h4><i class = "pronum">产品编号：6375878</i><b class = "prices">' +
        $(this)
          .parent()
          .nextAll("p")
          .next("b")
          .html() +
        '</b><div class = "goods"><strong class = "praise">好评率</strong><strong class = "pranum">100%</strong></div></div>'
  ...
  $(".con").click(function() {
    ...
    var reg = /^\d*$/;
    if (
      reg.test(parseInt($(".start").val())) &&
      reg.test(parseInt($(".ends").val()))
    ) {
      ...
      if (flagL) {
        $(
          '<div class = "notfound"><p>抱歉！没有找到符合您要求的<a href="javascript:;">“熊本...”</a>商品，</p><p>您可以<a href="javascript:;">改变搜索关键词</a>或<a href="javascript:;">减少分类条件</a>的限制试试。</p></div>'
        ).appendTo($(".listGoods"));
  ...
  function diyAjax(value) {
    if (value.new) {
      $(
        '<li><a href="javascript:;"><img class = "listImg" id = "' +
          value.goodid +
          '" src="' +
          value.srcs +
          '" alt=""></a><em></em><p><a href="javascript:;">' +
          value.pinner +
          '</a></p><b class = "sprice">' +
          value.price +
          "</b></li>"
  ...
  function objsort(obj) {
    ...
    for (var i = 0; i < obj.length; i++) {
      for (var j = 0; j < obj.length; j++) {
        if (
          parseInt(obj[i]["price"].split("￥")[1]) >
          parseInt(obj[j]["price"].split("￥")[1])
        ) {
          values = obj[j];
          obj[j] = obj[i];
          obj[i] = values;
  ...
  $(".H_L").click(function() {
    ...
    $(".pldown_a").css(
      "background",
      "url(../image/list/IMG/lowredjt.png) no-repeat 25px 10px"
    );
    $(".moren").css(
      "background",
      "url(http://i.vanclimg.com/search/sprites_20130606.png) no-repeat 30px -3078px"
    );
  ...
  $(".moren").click(function() {
    ...
    $(this).css(
      "background",
      "url(../image/list/IMG/jttop.png) no-repeat 25px 9px"
    );
    $(".pldown_a").css(
      "background",
      "url(../image/list/IMG/jttop2.png) no-repeat 25px 9px"
    );
  });
  //传递给详情页
